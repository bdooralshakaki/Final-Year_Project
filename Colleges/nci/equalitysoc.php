...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <center><h1 class="my-4"> Equality Society
        <small>nci</small>
      </h1> </center>
      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6 mb-4">
          <a href="#">
            <img class="img-fluid" src="../../img/nci/equalitypic1.jpg" alt="">
          </a>
        </div>

        <div class="col-md-3 col-sm-6 mb-4">
          <a href="#">
            <img class="img-fluid" src="../../img/nci/equalitypic2.jpg" alt="">
          </a>
        </div>

        <div class="col-md-3 col-sm-6 mb-4">
          <a href="#">
          <img class="img-fluid" src="../../img/nci/equalitypic3.jpg" alt="">
          </a>
        </div>

        <div class="col-md-3 col-sm-6 mb-4">
          <a href="#">
           <img class="img-fluid" src="../../img/nci/equalitypic4.jpg" alt="">
          </a>
        </div>
